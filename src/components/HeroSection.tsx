    ...
    <>
      <section className="relative h-screen flex items-center justify-center lightning-bg overflow-hidden pt-20">
        ...
        <div className="absolute top-20 left-20 group">
          <div className="w-48 h-32 playable-blur rounded-2xl animate-pulse opacity-60" />
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <span className="text-xs text-foreground/80 font-medium bg-background/80 px-2 py-1 rounded">Playable Ad</span>
          </div>
        </div>
        
        <div className="absolute top-40 right-32 group" style={{ animationDelay: '1s' }}>
          <div className="w-40 h-28 playable-blur rounded-2xl animate-pulse opacity-40" />
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <span className="text-xs text-foreground/80 font-medium bg-background/80 px-2 py-1 rounded">Interactive Ad</span>
          </div>
        </div>
        
        <div className="absolute bottom-32 left-32 group" style={{ animationDelay: '2s' }}>
          <div className="w-52 h-36 playable-blur rounded-2xl animate-pulse opacity-50" />
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <span className="text-xs text-foreground/80 font-medium bg-background/80 px-2 py-1 rounded">AI-Generated Playable</span>
          </div>
        </div>
        
        <div className="absolute bottom-20 right-20 group" style={{ animationDelay: '0.5s' }}>
          <div className="w-44 h-30 playable-blur rounded-2xl animate-pulse opacity-45" />
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <span className="text-xs text-foreground/80 font-medium bg-background/80 px-2 py-1 rounded">Demo Ad</span>
          </div>
        </div>
        
        <div className="absolute top-1/2 left-10 group" style={{ animationDelay: '1.5s' }}>
          <div className="w-36 h-24 playable-blur rounded-2xl animate-pulse opacity-35" />
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <span className="text-xs text-foreground/80 font-medium bg-background/80 px-2 py-1 rounded">Preview</span>
          </div>
        </div>
        
        <div className="absolute top-1/3 right-10 group" style={{ animationDelay: '3s' }}>
          <div className="w-40 h-28 playable-blur rounded-2xl animate-pulse opacity-55" />
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <span className="text-xs text-foreground/80 font-medium bg-background/80 px-2 py-1 rounded">Coming Soon</span>
          </div>
        </div>
